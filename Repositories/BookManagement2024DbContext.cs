...
public partial class BookManagement2024DbContext : DbContext
{
    public BookManagement2024DbContext()
    {
    }

    public BookManagement2024DbContext(DbContextOptions<BookManagement2024DbContext> options)
        : base(options)
    {
    }
    ...
    //hàm đọc kết nối CSDL từ file cấu hình appsettings.json
